...
public final class FingerPrint {
    ...
    private static float compare(byte[] f1,byte[] f2){
        if(f1.length!=f2.length)
            throw new IllegalArgumentException("mismatch myjavacv.fingerprint.FingerPrint length");
        int sameCount=0;
    ...
    public static void main(String[] args) throws IOException {
    	FingerPrint fp1 = new FingerPrint(ImageIO.read(new File("E:\\1.png")));
        FingerPrint fp2 =new FingerPrint(ImageIO.read(new File("E:\\2.png")));
